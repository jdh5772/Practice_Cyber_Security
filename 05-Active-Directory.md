...
- 우선적으로 `MSSQL` 취약점을 탐색.
- `AAD_987d7f2f57d2` : ADSync 서비스가 AAD_<랜덤값> 계정으로 실행될 수 있다.
- Azure AD Connect 설치 확인 → ADSync DB 연결 가능 여부 확인 → 연결 가능하고 버전·키 접근 조건이 맞으면 MSOL 복호화 스크립트 시도
...
---
<details>
  <summary><strong>AD Recycle Bin Feature(Restore deleted AD objects)</strong></summary>
...
---
<details>
  <summary><strong>WriteSPN</strong></summary>
